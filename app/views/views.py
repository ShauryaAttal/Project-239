...
"""
We fixed the IDOR Attack issue using session to get the user's current
session so that they cannot change the URL

We fixed the SQL injection issue using the filter_by function and
filtering the user_id
"""
@views.route('/profile')
@cross_origin()
def profile():
